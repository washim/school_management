...
SECRET_KEY = 'django-insecure-+#9!1r_0l5sq(b7j0ru3tp+=o_-l!anawvgf7l-cssln3)!d38'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'school_management' / 'database' / 'db.sqlite3',
    }
}
...
if os.environ.get("ENV_NAME") == 'PROD':
    ...
    BASE_URL = 'http://13.200.116.67:8000'